...
const ResumeAccordion = () => {
  const EXPERIENCES = [
    { 
      ...
      description: "Progressive experience from Junior Developer to Lead, leading a team of 2 developers while building internal business applications using React, TypeScript, and Firebase. Cut cloud costs by 50% ($20K/year) and built data pipelines with BigQuery, Cloud Functions, and ETL scripts. Launched three new applications including an AI chatbot and an investment management system, while maintaining two existing core business systems."
    },
    { 
